 ...
 *   <li>{@link com.br.refactoring.dsl.refactoring.PushDownAttribute#getSourceClassName <em>Source Class Name</em>}</li>
 *   <li>{@link com.br.refactoring.dsl.refactoring.PushDownAttribute#getTargetClassName <em>Target Class Name</em>}</li>
 *   <li>{@link com.br.refactoring.dsl.refactoring.PushDownAttribute#getAttributeToBePushedName <em>Attribute To Be Pushed Name</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PushDownAttribute extends DealingWithGeneralization {
	 ...
	 * @see com.br.refactoring.dsl.refactoring.RefactoringPackage#getPushDownAttribute_SourceClassName()
	 ...
	 * @see com.br.refactoring.dsl.refactoring.RefactoringPackage#getPushDownAttribute_TargetClassName()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Attribute To Be Pushed Name</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Attribute To Be Pushed Name</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Attribute To Be Pushed Name</em>' attribute.
	 * @see com.br.refactoring.dsl.refactoring.RefactoringPackage#getPushDownAttribute_AttributeToBePushedName()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	String getAttributeToBePushedName();
